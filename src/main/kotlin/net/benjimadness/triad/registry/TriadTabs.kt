            ...
            CreativeModeTab.builder()
                ...
                .displayItems { _, output ->
                    run {
                        ...
                        output.accept(TriadBlocks.BRONZE_SAWMILL)
                        output.accept(TriadBlocks.STEEL_CAPACITOR)
                        output.accept(TriadBlocks.STEEL_PUMP)
                        output.accept(TriadBlocks.STEEL_TANK)
                    }
                }
                .build()
        }
